...
gsap.from('.nav__item', {opacity:0, duration:3, delay: .5, y:35, ease:'expo.out', stagger: .2});

// Text
gsap.from('.home__title', {opacity:0, duration:3, delay: 1.3, y:35, ease:'expo.out'});
gsap.from('.home__subtitle', {opacity:0, duration:3, delay: 1.1, y:30, ease:'expo.out'});
